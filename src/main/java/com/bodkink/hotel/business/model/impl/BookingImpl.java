 ...
 *   <li>{@link com.bodkink.hotel.business.model.impl.BookingImpl#getService <em>Service</em>}</li>
 *   <li>{@link com.bodkink.hotel.business.model.impl.BookingImpl#getBookingBill <em>Booking Bill</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BookingImpl extends MinimalEObjectImpl.Container implements Booking, Serializable {
	 ...
	 * @ordered
	 */
	protected EList<BookingBill> bookingBill;
	...
	public EList<RoomReservation> getRoomReservation() {
		if (roomReservation == null) {
			roomReservation = new EObjectResolvingEList<RoomReservation>(RoomReservation.class, this, ModelPackage.BOOKING__ROOM_RESERVATION);
		}
	...
	public EList<Service> getService() {
		if (service == null) {
			service = new EObjectResolvingEList<Service>(Service.class, this, ModelPackage.BOOKING__SERVICE);
		}
		return service;
	}
	 ...
	 * @generated
	 */
	public EList<BookingBill> getBookingBill() {
		if (bookingBill == null) {
			bookingBill = new EObjectResolvingEList<BookingBill>(BookingBill.class, this, ModelPackage.BOOKING__BOOKING_BILL);
		}
		return bookingBill;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.BOOKING__BOOKING_BILL:
				...
				getBookingBill().addAll((Collection<? extends BookingBill>)newValue);
				return;
		}
