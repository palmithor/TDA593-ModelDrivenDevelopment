 ...
 * <ul>
 *   <li>{@link business.model.impl.RoomReservationImpl#getId <em>Id</em>}</li>
 *   <li>{@link business.model.impl.RoomReservationImpl#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link business.model.impl.RoomReservationImpl#getEndDate <em>End Date</em>}</li>
 *   <li>{@link business.model.impl.RoomReservationImpl#getGuest <em>Guest</em>}</li>
 *   <li>{@link business.model.impl.RoomReservationImpl#getRoomReservationType <em>Room Reservation Type</em>}</li>
 *   <li>{@link business.model.impl.RoomReservationImpl#getRoom <em>Room</em>}</li>
 *   <li>{@link business.model.impl.RoomReservationImpl#getRoomBill <em>Room Bill</em>}</li>
 *   <li>{@link business.model.impl.RoomReservationImpl#getReservationStatusEnum <em>Reservation Status Enum</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoomReservationImpl extends MinimalEObjectImpl.Container implements RoomReservation {
	 ...
	 * @ordered
	 */
	protected static final ReservationStatusEnum RESERVATION_STATUS_ENUM_EDEFAULT = ReservationStatusEnum.CHECKED_IN_LITERAL;
	...
	public EList getGuest() {
		if (guest == null) {
			guest = new EObjectResolvingEList(Guest.class, this, ModelPackage.ROOM_RESERVATION__GUEST);
		}
		return guest;
	}
