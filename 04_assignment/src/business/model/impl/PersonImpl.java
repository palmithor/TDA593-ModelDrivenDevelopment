 ...
 * <ul>
 *   <li>{@link business.model.impl.PersonImpl#getFirstName <em>First Name</em>}</li>
 *   <li>{@link business.model.impl.PersonImpl#getSurname <em>Surname</em>}</li>
 *   <li>{@link business.model.impl.PersonImpl#getBirthYear <em>Birth Year</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.PERSON__BIRTH_YEAR:
				return new Integer(getBirthYear());
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.PERSON__SURNAME:
				...
				return;
			case ModelPackage.PERSON__BIRTH_YEAR:
				setBirthYear(((Integer)newValue).intValue());
				return;
		}
