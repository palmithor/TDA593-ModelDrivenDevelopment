...
public class LogicFactoryImpl extends EFactoryImpl implements LogicFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case LogicPackage.GUEST_MANAGEMENT_IMPL: return createGuestManagementImpl();
			case LogicPackage.ROOM_EXTRA_MANAGEMENT_IMPL: return createRoomExtraManagementImpl();
			case LogicPackage.ROOM_MANAGEMENT_IMPL: return createRoomManagementImpl();
			case LogicPackage.SERVICE_MANAGEMENT_IMPL: return createServiceManagementImpl();
			case LogicPackage.BED_TYPE_MANAGEMENT_IMPL: return createBedTypeManagementImpl();
			case LogicPackage.BILLABLE_ITEM_MANAGEMENT_IMPL: return createBillableItemManagementImpl();
			case LogicPackage.BILLING_MANAGEMENT_IMPL: return createBillingManagementImpl();
			case LogicPackage.BOOKING_MANAGEMENT_IMPL: return createBookingManagementImpl();
			case LogicPackage.CUSTOMER_MANAGEMENT_IMPL: return createCustomerManagementImpl();
			case LogicPackage.ACCOUNT_MANAGEMENT_IMPL: return createAccountManagementImpl();
			default:
