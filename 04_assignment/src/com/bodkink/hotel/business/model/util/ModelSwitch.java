...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.BILLABLE_ITEM: {
				...
				T result = caseBillableItem(billableItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.ROOM_EXTRA_TEMPLATE: {
				...
				T result = caseRoomExtraTemplate(roomExtraTemplate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.RECEIPT_ITEM: {
				...
				T result = caseReceiptItem(receiptItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.CUSTOMER_USER_ACCOUNT: {
				...
				T result = caseCustomerUserAccount(customerUserAccount);
	 ...
	 * @generated
	 */
	public T caseBedType(BedType object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseBillableItem(BillableItem object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseRoomBill(RoomBill object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseRoomExtraTemplate(RoomExtraTemplate object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseReceiptItem(ReceiptItem object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseCustomerUserAccount(CustomerUserAccount object) {
		return null;
	}
