 ...
 * <ul>
 *   <li>{@link com.bodkink.hotel.business.model.impl.CustomerImpl#getPhone <em>Phone</em>}</li>
 *   <li>{@link com.bodkink.hotel.business.model.impl.CustomerImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link com.bodkink.hotel.business.model.impl.CustomerImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link com.bodkink.hotel.business.model.impl.CustomerImpl#getCardInformation <em>Card Information</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CustomerImpl extends PersonImpl implements Customer {
	...
	public EList<String> getNotes() {
		if (notes == null) {
			notes = new EDataTypeUniqueEList<String>(String.class, this, ModelPackage.CUSTOMER__NOTES);
		}
		return notes;
	}
