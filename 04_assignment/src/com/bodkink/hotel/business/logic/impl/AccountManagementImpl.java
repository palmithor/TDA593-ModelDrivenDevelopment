	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case LogicPackage.ACCOUNT_MANAGEMENT___CREATE_CUSTOMER_ACCOUNT__STRING_STRING_CUSTOMER:
				return createCustomerAccount((String)arguments.get(0), (String)arguments.get(1), (Customer)arguments.get(2));
			case LogicPackage.ACCOUNT_MANAGEMENT___CREATE_EMPLOYEE_ACCOUNT__STRING_STRING_USERGROUPENUM:
				return createEmployeeAccount((String)arguments.get(0), (String)arguments.get(1), (UserGroupEnum)arguments.get(2));
